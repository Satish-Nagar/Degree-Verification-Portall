...
const stats = [
  { label: 'Total Students', value: '2,500,000', icon: Users, delta: '+2.1% MoM' },
  { label: 'Total Institutions', value: '5,000', icon: School, delta: '+0.8% MoM' },
  { label: 'Total Verifications', value: '1,800,000', icon: CheckCircle, delta: '+3.4% MoM' },
  { label: 'Suspicious Flags', value: '214', icon: AlertTriangle, delta: '-12% MoM' },
];
